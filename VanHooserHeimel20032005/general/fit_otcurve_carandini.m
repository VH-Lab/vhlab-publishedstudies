function [otcurve,pref,hwhh]=fit_otcurve_carandini(curve,pref_hint,tw_hint,peak_hint,spont_hint )
%FIT_OTCURVE_CARANDINI fits orientation tuning curve
%
...
%
  ...
  par=fminsearch('carandini_orientation_fit_error',...
		 [spont_hint peak_hint pref_hint tw_hint peak_hint],search_options,...
		 curve(1,:),curve(2,:))';
