...
fnameprefix = '/Volumes/Data1/treeshrew_transLGNctx/';
...
if ~isempty(myassoc),
    ...
    ds = dirstruct(fname);
	[dummy,dummy,dummy,params,dummy,dummy,co]=singleunitgrating2(ds, mycell, mycellname, myassoc.data, 'angle', 0);
    ...
    best = findclosest(co.curve{1}(1,:),dirpref);
