...
for m=1:length(expernames),
    ...
    for i=1:length(cells),
        ...
        vpib  = findassociate(cells{i},'TP IPSI Ach OT visual response p','',''); 
        vpcb = findassociate(cells{i},'TP CONT Ach OT visual response p','','');
        ...
        vpia  = findassociate(cells{i},'TP IPSI ME Ach OT visual response p','',''); 
        vpca = findassociate(cells{i},'TP CONT ME Ach OT visual response p','','');
