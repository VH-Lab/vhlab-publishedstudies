...
for i=1:length(cells),
	DIb_associate = findassociate(cells{i},...
			['SP F0 ' test1 ' Ach OT Fit Direction index blr'],'','');
	DIa_associate = findassociate(cells{i},...
			['SP F0 ' test2 ' Ach OT Fit Direction index blr'],'','');
