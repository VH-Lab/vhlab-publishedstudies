function ds = DS_pop_tf(TFs,responses)
% DS_POP_TF = Compute DS, difference over sum, for a variety of measurements at different TFs
%
%   DS = DS_POP_TF(TFS, RESPONSES)
%
...
%
%   If neither direction exhibits a response, then DS is 0. If PREF is 0, then the DS is 1 if PREF-NULL
