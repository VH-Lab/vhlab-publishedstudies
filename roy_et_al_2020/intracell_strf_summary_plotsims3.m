...
for index=1:4,
	...
	plot(index+1+[1 1],[mean(sims_resps{age1}{age2}(:,plot_var))+[-1 1]*nanstderr(sims_resps{age1}{age2}(:,plot_var))],'k-');
...
plot([1 1],[mean(sims_resps_norandom{1}{1}(:,plot_var))+[-1 1]*nanstderr(sims_resps_norandom{1}{1}(:,plot_var))],'k-');
...
plot(7+[1 1],[mean(sims_resps_norandom{2}{2}(:,plot_var))+[-1 1]*nanstderr(sims_resps_norandom{2}{2}(:,plot_var))],'k-');
