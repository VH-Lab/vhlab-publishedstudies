function [cells,cellnames]=analyzemouseephys(thedir, redoresponses, redoanalysis, plotit, saveit)
% ANALYZEMOUSEEPHYS - Perform fitting analysis for a mouse ephys experiment
%
%  [CELLS,CELLNAMES]=ANALYZEMOUSEEPHYS(THEDIR, REDORESPONSES, REDOANALYSIS,...
%    PLOTIT, SAVEIT)
%
