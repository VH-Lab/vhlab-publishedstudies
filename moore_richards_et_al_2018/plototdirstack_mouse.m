...
pthreshold=0.05;
pthreshold_assoc = 'TP CONT Ach OT visual response p';
colorscale=1;
transparency = 0;
rotate=0;
imagesize=[512 512];
supressplot = 0;
dirthresh=0.5;
dir_assoc='TP CONT Ach OT Fit Direction index blr';
ot_assoc = 'TP CONT Ach OT Fit Pref';
otgray = 0;
otdirgreenblue = 0;
ordirbarandarrow = 1;
...
else, mathstr = 'mod(x,360)'; % 'mod(x-45,360)';
end;
