function [cells,cellnames]=analyze_mouse_tp(dirname,recalculate,dosave, plotit)
%  ANALYZE_MOUSE_TP - Perform analysis for Ye Li / Steve Van Hooser exper
%
...
if recalculate,
  for i=1:length(cells),
	...
	[cellnames{i} ', ' int2str(i) ' of ' int2str(length(cells))],
  end;
end;
