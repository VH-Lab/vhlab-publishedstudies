...
for i=1:length(cells),
        ...
        %dias.data,
            ...
            elseif otdirgreenblue,
                ...
                symsize(i,[1 2]) = [12 12];
            elseif dirgreenblue,
                if abs(dias.data)>0.5, cols(i,:) = [ 1 0 0];%[1 0 0]red [0 1 0]green [0 0 1]blue [1 1 0]yellow
                else, cols(i,:) = [ 0 1 0];
            	end;
...
[im,scalebarax,scalebarimg]=pvcontinuousmapNEW(imagesize,1,cells,cellnames(mycells),ot_assoc,mathstr,0:179,~supressplot,'pvalueassoc',pthreshold_assoc,'pvalue',pthreshold,'symbol',symb,'symbolsize',symsize,'colors',cols,...
