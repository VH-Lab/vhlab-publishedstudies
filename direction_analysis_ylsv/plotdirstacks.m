...
expnames = {'2006-08-17','2006-11-30','2007-02-01','2007-02-21','2007-03-01','2007-03-07','2007-05-01',...
        '2007-06-27','2007-06-28','2007-08-30',...
...
condnamef1 = {'WArAll_', 'WArBAME_', 'WArBAFE_','WArBAFEME_'};
			...
			if length(inds)>0,
				for k=1:3,
					for t=1:length(threshold),
						im=plototdirstack(mycells,stacknames{s},'otdirgreenblue',1,'otgray',0,'ot_assoc',property{k},...
							 'dir_assoc',dirproperty{k},'dirthresh',threshold(t),'pthreshold_assoc',pthreshold_assoc{k},...
							 'rotate',0,'ds',ds,'cellnames',mycellnames,'image_background_color',0);
