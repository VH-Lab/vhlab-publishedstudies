...
pthreshold_assoc = {'TP Ach OT visual response p','TP ME Ach OT visual response p'};
...
for i=1:length(expernames),
	...
	for j=1:length(cells),
		...
		vpt   = findassociate(cells{j},'TP ME Ach OT visual response p','','');
		vecp   = findassociate(cells{j},'TP Ach OT vec varies p','','');
		vecpt   = findassociate(cells{j},'TP ME Ach OT vec varies p','','');
		OTi  = findassociate(cells{j},'TP Ach OT Fit Orientation index','','');
		OTit  = findassociate(cells{j},'TP ME Ach OT Fit Orientation index','','');
		OTr = findassociate(cells{j},'TP Ach OT Response curve','','');
		OTrt = findassociate(cells{j},'TP ME Ach OT Response curve','','');
		OTr2 = findassociate(cells{j},'TP Ach OT Fit R2','','');
		OTr2t = findassociate(cells{j},'TP ME Ach OT Fit R2','','');
		OTfit = findassociate(cells{j},'TP Ach OT Carandini Fit Params','','');
		OTfitt= findassociate(cells{j},'TP ME Ach OT Carandini Fit Params','','');
		tw = findassociate(cells{j},'TP Ach OT Tuning width','','');
		twt = findassociate(cells{j},'TP ME Ach OT Tuning width','','');
		...
		if ~isempty(dirf2)&~isempty(dirf2t)&vecp.data<0.05&vecpt.data<0.05,
			...
			Dirpreft = findassociate(cells{j},'TP ME Ach OT Fit Pref','','');
	...
	[Xn,Yn]=tpscatterplot(mycells,mycellnames,'TP Ach OT Fit Pref','x','TP ME Ach OT Fit Pref','y',2,...
...
title(['Angle preference before and after training']);
