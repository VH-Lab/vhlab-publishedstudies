function output = sTestDoubleGaussDS(varargin)
...
%
%   Example:
%   sTestDoubleGaussDS('num_repeats_per_sim',100,'noise_level',2)
...
for i=1:21,
		...
		[dummy,real_fit] = otfit_carandini_err([0 10 Opref_theory(i,j) sigma_theory(i,j) 10-(i-1)/2],0:359);
		di_theory(i,j) = compute_directionindex(0:359,real_fit);
		output = OriDirCurveDemo('Rp',10,'Rn',10-(i-1)/2,'Rsp',0,'Opref',Opref_theory(i,j),...
