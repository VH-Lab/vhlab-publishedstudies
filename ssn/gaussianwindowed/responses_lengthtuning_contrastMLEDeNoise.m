...
for i=1:length(goodlist),
	[dummy,dummy,dummy,dummy,dummy,s,co] = singleunitgrating_slowdenoise(ds,newcell,mycellname,goodlist{i},'stimnumber',0,0,1);
...
responses.f0vals{1} = responses.indresps;
responses.f1vals{1} = responses.f1indresps;
...
if gausswind,
	typestring = 'Contrast/length MLE gauss resp';
else,
	typestring = 'Contrast/length MLE sharp resp';
end;
